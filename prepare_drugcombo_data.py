...
with open(os.path.join(splits_dir, f"DrugCombo_split_0_test.txt"), "w") as f:
    f.write("\n".join(map(str, test_num)))

with open(os.path.join(splits_dir, f"DrugCombo_split_0_val.txt"), "w") as f:
    f.write("\n".join(map(str, val_num)))

with open(os.path.join(splits_dir, f"DrugCombo_split_0_train.txt"), "w") as f:
    f.write("\n".join(map(str, train_num)))

print(f"Saved to splits/: DrugCombo_split_0_test.txt, DrugCombo_split_0_val.txt, DrugCombo_split_0_train.txt")
